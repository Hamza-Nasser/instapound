...
class AppColors {
  // You can use HexColor class to convert hex to color object like this: HexColor('#FFFFFF') or HexColor('FFFFFF')
  static const Color primary = Color(0xFFFFFFFF); //  Blue
  static const Color primaryDark = Color(0xFF000000); //
  static const Color primaryAccent = Color(0xFF1877F2); //  Blue
  static const Color secondary = Color(0xFF2D2D2D); // Dark Grey
